...
import { LogisticsFindManyArgs } from "../../logistics/base/LogisticsFindManyArgs";
...
export class OrderControllerBase {
  ...
  @common.Get("/:id/logisticsItems")
  @ApiNestedQuery(LogisticsFindManyArgs)
  async findLogisticsItems(
    @common.Req() request: Request,
    @common.Param() params: OrderWhereUniqueInput
  ): Promise<Logistics[]> {
    const query = plainToClass(LogisticsFindManyArgs, request.query);
    const results = await this.service.findLogisticsItems(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/logisticsItems")
  async connectLogisticsItems(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: LogisticsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      logisticsItems: {
        connect: body,
  ...
  @common.Patch("/:id/logisticsItems")
  async updateLogisticsItems(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: LogisticsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/logisticsItems")
  async disconnectLogisticsItems(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: LogisticsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  async NotifyDeliveryService(
    @common.Body()
    body: Order
  ): Promise<string> {
    return this.service.NotifyDeliveryService(body);
  }
}
