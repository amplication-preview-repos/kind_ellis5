...
export class OrderResolverBase {
  ...
  @graphql.ResolveField(() => [Logistics], { name: "logisticsItems" })
  async findLogisticsItems(
    @graphql.Parent() parent: Order,
    @graphql.Args() args: LogisticsFindManyArgs
  ): Promise<Logistics[]> {
    const results = await this.service.findLogisticsItems(parent.id, args);
  ...
  async NotifyDeliveryService(
    ...
    return this.service.NotifyDeliveryService(args);
  }
}
