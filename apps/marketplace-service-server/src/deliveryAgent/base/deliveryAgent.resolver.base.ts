...
import { DeliveryService } from "../../deliveryService/base/DeliveryService";
...
export class DeliveryAgentResolverBase {
  ...
  async createDeliveryAgent(
    ...
    return await this.service.createDeliveryAgent({
      ...
      data: {
        ...
        deliveryService: args.data.deliveryService
          ? {
              connect: args.data.deliveryService,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => DeliveryService, {
    nullable: true,
  ...
  async getDeliveryService(
    ...
    const result = await this.service.getDeliveryService(parent.id);
